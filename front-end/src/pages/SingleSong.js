  ...
  return (
    <div className="-m-4 lg:-m-8 xl:-m-16">
      <div className="p-4 lg:p-8 xl:p-16 w-full flex items-end  gap-8 bg-gradient-to-r from-black to-green-800">
        ...
        <div>
          <p className="text-gray-100 text-5xl font-semibold">{details.name}</p>
          ...
          <div className="flex mt-4 gap-6 flex-wrap">
            ...
            <button className="text-white rounded-md px-4 py-2 border border-gree">Get Recommendations</button>
          </div>
        </div>
      </div>
